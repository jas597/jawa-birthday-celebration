export const birthdayConfig = {
  ...
  welcomeTitle: "A Special Birthday Experience Is Waiting for You",
  welcomeSubtitle: "We have created something special to celebrate your day.",

  mainBirthdayMessage:
    "Your leadership, support, and guidance inspire us every day. Today, we have prepared a small digital surprise especially for you.",

  finalTitle: "Thank You for Being an Amazing Leader",
  finalMessage:
  ...
  // Replace these paths after adding your own files in public/audio/.
  backgroundMusicPath: null,
  birthdayMusicPath: "/audio/cake-birthday-music.mp3",
  candleCheerPath: "/audio/candle-cheer.mp3",
  surpriseOpenSoundPath: "/audio/surprise-open-wow.mp3",

  dedications: [
    {
      id: 1,
      person: "Maria",
      label: "Maria's Surprise",
      title: "A Special Song from Maria",
      message:
    ...
    },
    {
      id: 2,
      person: "Sasi",
      label: "Sasi's Surprise",
      title: "A Special Surprise from Sasi",
      message:
    ...
    },
    {
      id: 3,
      person: "Jas",
      label: "Jas's Surprise",
      title: "A Special Song from Jas",
      message:
    ...
    },
    {
      id: 4,
      person: "Kim",
      label: "Kim's Surprise",
      title: "A Special Song from Kim",
      message:
    ...
    },
    {
      id: 5,
      person: "Kanna",
      label: "Kanna's Surprise",
      title: "A Special Song from Kanna",
      message:
